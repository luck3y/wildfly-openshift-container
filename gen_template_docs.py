...
GIT_REPO = "https://github.com/jboss-container-images/jboss-eap-7-openshift-image/"
REPO_NAME = "jboss-eap-7-openshift-image/"
TEMPLATE_DOCS = "docs/"
template_dirs = [ 'templates' ]
amq_ssl_desc = None

LINKS =  {"eap-cd-openshift:15": "../{outfilesuffix}[``]" }
